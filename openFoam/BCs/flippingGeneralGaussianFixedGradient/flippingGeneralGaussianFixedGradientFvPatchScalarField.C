...
#include "flippingGeneralGaussianFixedGradientFvPatchScalarField.H"
...
flippingGeneralGaussianFixedGradientFvPatchScalarField::flippingGeneralGaussianFixedGradientFvPatchScalarField
(
    const fvPatch& p,
...
flippingGeneralGaussianFixedGradientFvPatchScalarField::flippingGeneralGaussianFixedGradientFvPatchScalarField
(
    const flippingGeneralGaussianFixedGradientFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
    ...
    oldTime_(readScalar(dict.lookup("oldTime")))
{
    ...
    {
        FatalErrorIn("flippingGeneralGaussianFixedGradientFvPatchScalarField(dict)")
...
flippingGeneralGaussianFixedGradientFvPatchScalarField::flippingGeneralGaussianFixedGradientFvPatchScalarField
(
    const flippingGeneralGaussianFixedGradientFvPatchScalarField& fcvpvf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
void flippingGeneralGaussianFixedGradientFvPatchScalarField::updateCoeffs()
{
...
// Write
void flippingGeneralGaussianFixedGradientFvPatchScalarField::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchScalarField, flippingGeneralGaussianFixedGradientFvPatchScalarField);
