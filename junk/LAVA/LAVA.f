...
C================================================================LAVA
     ...
     4     PLOT,PRINT,PSTATE,RDIVID,REPACK,
...
c      IF(TIME.GE.TIMPTL .AND. IPTCL.EQ.1) THEN
c           IF(NUMNOZ.GE.1) CALL INJECT
C----------------------------------------------------------------LAVA
...
c           IF(IEVAP.EQ.1) CALL REPACKEVAP
c           CALL PFIND
