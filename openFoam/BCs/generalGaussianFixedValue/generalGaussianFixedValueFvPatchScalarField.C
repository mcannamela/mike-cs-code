...
#include "generalGaussianFixedValueFvPatchScalarField.H"
...
generalGaussianFixedValueFvPatchScalarField::generalGaussianFixedValueFvPatchScalarField
(
    const fvPatch& p,
...
generalGaussianFixedValueFvPatchScalarField::generalGaussianFixedValueFvPatchScalarField
(
    const generalGaussianFixedValueFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
    ...
    muz_(readScalar(dict.lookup("muz")))
{
    ...
    {
        FatalErrorIn("generalGaussianFixedValueFvPatchScalarField(dict)")
...
generalGaussianFixedValueFvPatchScalarField::generalGaussianFixedValueFvPatchScalarField
(
    const generalGaussianFixedValueFvPatchScalarField& fcvpvf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
void generalGaussianFixedValueFvPatchScalarField::updateCoeffs()
{
...
// Write
void generalGaussianFixedValueFvPatchScalarField::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchScalarField, generalGaussianFixedValueFvPatchScalarField);
