...
#include "gaussianFixedGradientFvPatchScalarField.H"
...
gaussianFixedGradientFvPatchScalarField::gaussianFixedGradientFvPatchScalarField
(
    const fvPatch& p,
...
gaussianFixedGradientFvPatchScalarField::gaussianFixedGradientFvPatchScalarField
(
    const gaussianFixedGradientFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
    ...
    muz_(readScalar(dict.lookup("muz")))
{
    ...
    {
        FatalErrorIn("gaussianFixedGradientFvPatchScalarField(dict)")
...
gaussianFixedGradientFvPatchScalarField::gaussianFixedGradientFvPatchScalarField
(
    const gaussianFixedGradientFvPatchScalarField& fcvpvf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
void gaussianFixedGradientFvPatchScalarField::updateCoeffs()
{
...
// Write
void gaussianFixedGradientFvPatchScalarField::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchScalarField, gaussianFixedGradientFvPatchScalarField);
