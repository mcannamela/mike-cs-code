...
#include "gaussianFixedValueFvPatchScalarField.H"
...
gaussianFixedValueFvPatchScalarField::gaussianFixedValueFvPatchScalarField
(
    const fvPatch& p,
...
gaussianFixedValueFvPatchScalarField::gaussianFixedValueFvPatchScalarField
(
    const gaussianFixedValueFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
    ...
    muz_(readScalar(dict.lookup("muz")))
{
    ...
    {
        FatalErrorIn("gaussianFixedValueFvPatchScalarField(dict)")
...
gaussianFixedValueFvPatchScalarField::gaussianFixedValueFvPatchScalarField
(
    const gaussianFixedValueFvPatchScalarField& fcvpvf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
void gaussianFixedValueFvPatchScalarField::updateCoeffs()
{
...
// Write
void gaussianFixedValueFvPatchScalarField::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchScalarField, gaussianFixedValueFvPatchScalarField);
