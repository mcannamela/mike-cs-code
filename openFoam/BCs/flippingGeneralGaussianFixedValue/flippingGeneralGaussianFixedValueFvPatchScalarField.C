...
#include "flippingGeneralGaussianFixedValueFvPatchScalarField.H"
...
flippingGeneralGaussianFixedValueFvPatchScalarField::flippingGeneralGaussianFixedValueFvPatchScalarField
(
    const fvPatch& p,
...
flippingGeneralGaussianFixedValueFvPatchScalarField::flippingGeneralGaussianFixedValueFvPatchScalarField
(
    const flippingGeneralGaussianFixedValueFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
    ...
    oldTime_(readScalar(dict.lookup("oldTime")))
{
    ...
    {
        FatalErrorIn("flippingGeneralGaussianFixedValueFvPatchScalarField(dict)")
...
flippingGeneralGaussianFixedValueFvPatchScalarField::flippingGeneralGaussianFixedValueFvPatchScalarField
(
    const flippingGeneralGaussianFixedValueFvPatchScalarField& fcvpvf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
void flippingGeneralGaussianFixedValueFvPatchScalarField::updateCoeffs()
{
    ...
    //scalarField& r =  pow(sqr(c.component(0)-mux())+sqr(c.component(2)-muy())+sqr(c.component(2)-muz()),.5);
    ...
    //scalarField::operator=(offset()+maxVal()*exp(-pow(mag(c-mu())/sx()),n()));
}


// Write
void flippingGeneralGaussianFixedValueFvPatchScalarField::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchScalarField, flippingGeneralGaussianFixedValueFvPatchScalarField);
